...
"""
    get_streams(scale_factor::AbstractString)::Int

Return the number of streams required for the specified scale factor.
"""
function get_streams(scale_factor::AbstractString)::Int
    if scale_factor in keys(sf_streams)
        sf_streams[scale_factor]
    else
        1
    end
end

...
TEST_F(OptimizationTest, FullApplication7) { OPT_EXPECT_EQ(TranslateFormula("{1}(x)"), "SELECT 1 AS x"); }
...
TEST_F(OptimizationTest, RelationalAbstraction2) { OPT_EXPECT_EQ(TranslateExpression("{1}"), "SELECT 1 AS A1"); }

TEST_F(OptimizationTest, RelationalAbstraction3) { OPT_EXPECT_EQ(TranslateExpression("{(1)}"), "SELECT 1 AS A1"); }

TEST_F(OptimizationTest, RelationalAbstraction4) {
...
TEST_F(OptimizationTest, BindingEquality) { OPT_EXPECT_EQ(TranslateExpression("(x): x = 1"), "SELECT 1 AS A1"); }
